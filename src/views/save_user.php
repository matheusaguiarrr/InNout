<main class="content">
    <?php
        loadTitle(
            ...
            'Crie e atualize os usuários do sistema',
            'icofont-user'
        );
    ...
    <form action="#" method="post">
        ...
        <div class="form-row">
            <div class="form-group col-md-6">
                ...
                <input type="text" id="name" name="name" placeholder="Informe o nome" class="form-control <?= isset($errors['name']) ? 'is-invalid' : '' ?>" value="<?= $name ?? "" ?>">
        ...
        <div class="form-row">
            <div class="form-group col-md-6">
                ...
                <input type="checkbox" id="is_admin" name="is_admin" class="form-control <?= isset($errors['is_admin']) ? 'is-invalid' : '' ?>" <?= isset($is_admin) && $is_admin ? 'checked' : '' ?>>
                <div class="invalid-feedback">
                    <?= $errors['is_admin'] ?>
                </div>
            </div>
